                    ...
                    <form onSubmit={handleUpload} className="mt-4">
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          name="subject"
                          id="subject"
                          value={uploadFormData.NotesSubject}
                          onChange={handleUploadFormChange}
                          required
                          className="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                        />
                      ...
                      <div className="mb-4">
                        ...
                        <textarea
                          ...
                          name="description"
                          rows="3"
                          value={uploadFormData.Notesdescription}
                          onChange={handleUploadFormChange}
                          className="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                        ></textarea>
                      </div>
  ...
  return [
    {
      ...
      description: 'Comprehensive lecture notes covering all DSA topics including arrays, linked lists, trees, graphs, and algorithms.',
      subject: 'Data Structures',
      semester: '3rd Semester',
      fileType: 'pdf',
      size: '4.2 MB',
      uploadedAt: new Date() - 1000*60*60*24*2,
      downloads: 128,
      uploadedBy: 'Prof. Johnson'
    },
    {
      id: 2,
      title: 'Database Systems - SQL Queries Practice Set',
      description: 'A collection of SQL queries with solutions for practice. Covers basic to advanced queries.',
      subject: 'Database Systems',
      semester: '4th Semester',
      fileType: 'pdf',
      size: '2.8 MB',
      uploadedAt: new Date() - 1000*60*60*24*5,
      downloads: 95,
    ...
    },
    {
      ...
      description: 'Slides covering network layers, protocols, and security concepts from the latest lectures.',
      subject: 'Computer Networks',
      semester: '5th Semester',
      fileType: 'pptx',
      size: '8.5 MB',
      uploadedAt: new Date() - 1000*60*60*24*7,
      downloads: 112,
    ...
    },
    {
      ...
      description: 'Detailed notes on process management, scheduling algorithms, and concurrency.',
      subject: 'Operating Systems',
      semester: '5th Semester',
      fileType: 'pdf',
      size: '3.1 MB',
      uploadedAt: new Date() - 1000*60*60*24*10,
      downloads: 87,
      uploadedBy: 'Prof. Davis'
    },
    {
      id: 5,
      title: 'Machine Learning - Assignment 2 Solutions',
      description: 'Solutions to Assignment 2 covering regression models and evaluation metrics.',
      subject: 'Machine Learning',
      semester: '7th Semester',
      fileType: 'pdf',
      size: '1.5 MB',
      uploadedAt: new Date() - 1000*60*60*24*12,
      downloads: 76,
      uploadedBy: 'Prof. Taylor'
    },
    {
      id: 6,
      title: 'Web Development - HTML/CSS Reference Guide',
      description: 'A comprehensive reference guide for HTML5 tags and CSS3 properties with examples.',
      subject: 'Web Development',
      semester: '6th Semester',
      fileType: 'docx',
      size: '2.3 MB',
      uploadedAt: new Date() - 1000*60*60*24*15,
      downloads: 104,
      uploadedBy: 'Prof. Brown'
    },
    {
      id: 7,
      title: 'Artificial Intelligence - Project Guidelines',
      description: 'Guidelines and requirements for the semester project on AI applications.',
      subject: 'Artificial Intelligence',
      semester: '7th Semester',
      fileType: 'pdf',
      size: '1.2 MB',
      uploadedAt: new Date() - 1000*60*60*24*18,
      downloads: 63,
    ...
    },
    {
      ...
      description: 'Real-world case studies of software development projects and lessons learned.',
      subject: 'Software Engineering',
      semester: '6th Semester',
      fileType: 'pptx',
      size: '5.7 MB',
      uploadedAt: new Date() - 1000*60*60*24*21,
      downloads: 91,
      uploadedBy: 'Prof. Wilson'
    },
    {
      id: 9,
      title: 'Computer Architecture - Exam Preparation Guide',
      description: 'Study guide covering all important topics for the upcoming exam with practice questions.',
      subject: 'Computer Architecture',
      semester: '4th Semester',
      fileType: 'pdf',
      size: '2.9 MB',
      uploadedAt: new Date() - 1000*60*60*24*25,
      downloads: 156,
      uploadedBy: 'Prof. Martinez'
    },
    {
      id: 10,
      title: 'Algorithms - Greedy Approach Notes',
      description: 'Detailed notes on greedy algorithms with examples and complexity analysis.',
      subject: 'Algorithms',
      semester: '3rd Semester',
      fileType: 'pdf',
      size: '1.8 MB',
      uploadedAt: new Date() - 1000*60*60*24*30,
      downloads: 118,
      uploadedBy: 'Prof. Johnson'
    },
    {
      id: 11,
      title: 'Programming Lab - Practice Problems',
      description: 'A set of programming problems to practice coding skills in various languages.',
      subject: 'Programming Lab',
      semester: '2nd Semester',
      fileType: 'docx',
      size: '950 KB',
      uploadedAt: new Date() - 1000*60*60*24*35,
      downloads: 142,
      uploadedBy: 'Prof. Lee'
    },
    {
      id: 12,
      title: 'Mobile App Development - Project Showcase',
      description: 'Presentation of exemplary student projects from previous semesters.',
      subject: 'Mobile App Development',
      semester: '8th Semester',
      fileType: 'pptx',
      size: '7.2 MB',
      uploadedAt: new Date() - 1000*60*60*24*40,
      downloads: 85,
